"""
Django settings for teswtinstalluser_6 project.
...
ROOT_URLCONF = 'teswtinstalluser_6.urls'
...
WSGI_APPLICATION = 'teswtinstalluser_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "teswtinstalluser_6 API",
    "DESCRIPTION": "API documentation for teswtinstalluser_6 App",
    "VERSION": "v1",
}
